      ...
      <div className="container mx-auto my-10 ">
              ...
              return (
                <div key={index} className="w-96 my-2 p-2 flex  items-center">
                  ...
                  <div className="text-[#99988b]">
                    ...
                    <div className="">
                      <p className="">
                        {ca.person.country && ca.person.country.name}{" "}
                        {ca.person.birthday}
                      </p>
                    </div>
                  </div>
        ...
        <button
          ...
          className={
            number > 12
              ? "hidden"
              : "block  mx-auto block text-[#D32444] text-[20px] text-center  "
          }
        >
          see more
        </button>
        <button
          ...
          className={
            number <= 12
              ? "hidden"
              : " block mx-auto text-[#D32444] text-[20px] text-center  "
          }
        >
          hide
        </button>
