  ...
  return (
    <>
      <div
        style={{
          backgroundImage: `url(${
            anime.trailer && anime.trailer.images.maximum_image_url
          })`,
        }}
        ...
        <div className=" absolute md:top-[30%] top-[10%]  md:left-[5%] left-1 md:w-[1000px] w-96  h-[300px] items-center     flex md:flex-nowrap flex-wrap justify-center  container mx-auto">
          ...
          <div className="">
            ...
            <p
              ...
              className="text-gray-100 text-sm drop-shadow-2xl"
            >
              {anime.synopsis}
            </p>
            <div className="flex mt-2 md:mb-4 mb-1 items-center  px-1">
              ...
              <span className="border rounded-xl px-2">
                ...
                {anime.aired && anime.aired.prop.from.month}/
                {anime.aired && anime.aired.prop.from.year}{" "}
              </span>
            </div>
            <div>
      ...
      >
        <div className="relative">
          <iframe
            className="rounded-2xl auto md:w-[974px] w-96   md:h-[548px] h-80 "
