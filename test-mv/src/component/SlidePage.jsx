      ...
      >
         {
                movies.map((movie , index)=>{
                    ...
                    return(
                        <SwiperSlide key={index}>
                             <div style={{  backgroundImage: `url(${url})`} } key={index}
            ...
            <div className=' absolute top-[20%] md:left-[5%] left-1 md:w-[500px] w-80  h-[300px]      container mx-auto'>
                ...
                <h1 className='mx-2 my-3 text-4xl'>{movie.original_title}</h1>
                    ...
                    <div>
                    <div className='flex items-center'>
                    <button type="button" className="text-white bg-[#D32444]  focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2  focus:outline-none dark:focus:ring-blue-800">Book now</button>
