...
const SlidePage = () => {
  ...
  useEffect(() => {
    fetch(
      "https://api.themoviedb.org/3/movie/popular?api_key=08399bf740a4d93d9e75e8a3a6917e88&language=en-US"
    )
      .then((res) => res.json())
      .then((data) => {
            ...
            <SwiperSlide key={index}>
              ...
              >
                <div className=" absolute top-[20%] md:left-[5%] left-1 md:w-[500px] w-80  h-[300px]      container mx-auto">
                  <img
                    className="h-full rounded-2xl  mx-9 shadow-xl  shadow-black"
